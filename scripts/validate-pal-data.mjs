...
const coverage = {
  ...
  partnerSkillNameZh: pals.filter((pal) => pal.partnerSkill.nameZh !== null && pal.partnerSkill.nameZh !== undefined).length,
  partnerSkillDescription: pals.filter((pal) => pal.partnerSkill.description !== null).length,
  partnerSkillDescriptionZh: pals.filter((pal) => pal.partnerSkill.descriptionZh !== null && pal.partnerSkill.descriptionZh !== undefined).length,
