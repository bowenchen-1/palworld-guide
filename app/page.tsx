    ...
    <section className="hero-sky relative min-h-[720px] px-5 pb-28 pt-5 sm:px-8 lg:px-12">
      ...
      <div className="mx-auto max-w-[1360px]"><SiteHeader floating />
        <div id="top" className="relative z-10 grid items-center gap-14 pb-10 pt-20 lg:grid-cols-[1.08fr_.92fr] lg:pt-24">
          <div className="max-w-3xl"><div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#287a68]/15 bg-white/65 px-4 py-2 text-xs font-extrabold uppercase tracking-[.17em] text-[#287a68] shadow-sm backdrop-blur"><span className="h-2 w-2 rounded-full bg-[#ff7b70]" /> Updated for Palworld 1.0</div>
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-[#456c68] sm:text-xl">Find breeding combinations, current Pal data, work suitability, and player-researched version 1.0 guides.</p>
            <div className="mt-9 flex flex-wrap items-center gap-4"><Link href="/breeding-calculator" className="rounded-2xl bg-[#ff786e] px-7 py-4 font-extrabold text-white shadow-[0_7px_0_#ce514b] transition hover:-translate-y-1">Breeding Calculator →</Link><Link href="/paldex" className="rounded-2xl border-2 border-[#287a68]/20 bg-white/55 px-7 py-4 font-extrabold text-[#215f53] backdrop-blur transition hover:bg-white">Browse All Pals</Link></div>
            <div id="site-search"><GlobalSearch /></div>
          </div>
          <div className="hero-art relative mx-auto h-[420px] w-full max-w-[570px] lg:h-[500px]" aria-label="A playful illustrated island landscape"><div className="floating-badge badge-top"><span className="text-xl">◉</span><div><b>1.0 breeding data</b><small>300 current records</small></div></div><div className="floating-badge badge-bottom"><span className="text-xl">✦</span><div><b>289 Pal profiles</b><small>Search in seconds</small></div></div><div className="island island-back" /><div className="island island-main"><span className="tree tree-a" /><span className="tree tree-b" /><span className="tree tree-c" /><span className="path" /><div className="pal" aria-hidden="true"><span className="pal-ear left" /><span className="pal-ear right" /><span className="pal-face"><i /><i /></span><span className="pal-pack" /></div></div><div className="island island-small" /></div>
        </div>
      </div><div className="hill hill-back" aria-hidden="true" /><div className="hill hill-front" aria-hidden="true" />
    </section>

    <section id="tools" className="tool-lab-section px-5 py-24 sm:px-8 lg:px-12"><div className="mx-auto max-w-[1360px]"><div className="mb-12 grid gap-6 lg:grid-cols-[1fr_.7fr] lg:items-end"><div><p className="eyebrow">Popular Palworld Tools</p><h2 className="section-title mt-3 text-white">Start here.<br />Finish in the full tool.</h2></div><p className="max-w-lg text-lg leading-8 text-[#b9d8ce]">Run a quick breeding check or preview a Pal profile on the homepage. Deeper filters stay in focused tool pages.</p></div><HomeToolBoard /><div className="mini-tool-heading"><span>Quick planning calculators</span><Link href="/tools">View every tool →</Link></div><ToolLab /></div></section>
