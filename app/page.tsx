...
export default function Home() {
  ...
  return <main id="main-content" className="min-h-screen overflow-hidden bg-canvas text-foreground">
    ...
    <section id="top" className="home-calculator-top px-5 pb-12 sm:px-8 lg:px-12"><div className="mx-auto max-w-[1320px]"><SiteHeader floating /><div className="home-calculator-intro"><p className="terminal-kicker"><span /> Field Research // Updated for Palworld 1.0</p><h1>Palworld Breeding Calculator</h1><p>Calculate offspring, reverse-search parents, and plan routes from your available Pal species with the current 1.0 breeding matrix.</p></div><BreedingClient embedded /></div></section>
