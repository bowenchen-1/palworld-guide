...
export default function HardwoodPage() {
  return <main id="main-content" className="hardwood-page min-h-screen bg-canvas text-foreground">
    ...
    <div className="hardwood-wrap">
      ...
      <section className="hardwood-section hardwood-source-methods" id="sources"><div className="hardwood-section-heading"><p className="hardwood-kicker">04 · Source comparison</p><h2>Every way to get Hardwood</h2></div><div className="hardwood-source-method-grid">{sourceMethods.map(([name, meta, note]) => <article key={name}><span>{meta}</span><h3>{name}</h3><p>{note}</p></article>)}</div></section>

      <section className="hardwood-section" id="tips"><div className="hardwood-section-heading"><p className="hardwood-kicker">05 · Farm smarter</p><h2>Three field tips</h2></div><div className="hardwood-tip-cards"><article><span>01</span><h3>Carry space</h3><p>Empty your inventory before a long grove run.</p></article><article><span>02</span><h3>Pick the right route</h3><p>Use Twilight Dunes earlier; save Sakurajima for bulk.</p></article><article><span>03</span><h3>Use base production</h3><p>Let a Lumbering Pal handle repeat supply.</p></article></div></section>
