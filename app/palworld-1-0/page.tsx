...
const faqs = [
  ...
  ["How many Pals are in the current database?", `Our version 1.0 visible catalog contains ${palCounts.pals} Pals (${palCounts.standardPals} standard and ${palCounts.crossoverCreatures} crossover). The breeding matrix remains ${palCounts.records} records.`],
