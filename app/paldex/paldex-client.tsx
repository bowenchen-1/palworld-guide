...
const tableColumns = ["Pal", "Element", "Work Suitability", "Partner Skill", "Drops", "Locations", "Rarity", "HP", "Defense", "Breeding Power", "Breeding"] as const;
const tableColumnWidths = [110, 78, 210, 160, 120, 145, 48, 52, 56, 78, 110] as const;
...
function PaldexTableHead({ frozen = false }: { frozen?: boolean }) {
  ...
  const labels = locale === "zh" ? ["帕鲁", "属性", "工作适应性", "伙伴技能", "掉落物", "出没地点", "稀有度", "生命值", "防御", "配种力", "配种"] : tableColumns;
