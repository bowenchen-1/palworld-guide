...
export default function PaldexPageContent({ initialPage = 1, initialQuery = "", locale = "en" }: { initialPage?: number; initialQuery?: string; locale?: Locale }) {
  ...
  if (isZh) return <ToolShell current="/zh/pals" locale="zh" breadcrumb={[{ name: "首页", path: "/zh/" }, { name: "帕鲁图鉴", path: "/zh/pals" }]}>
    ...
    <PaldexClient initialPage={initialPage} initialQuery={initialQuery} locale="zh" />
  ...
  return <ToolShell current={isZh ? "/zh/pals" : "/pals"} locale={locale} breadcrumb={[{ name: isZh ? "首页" : "Home", path: `${base}/` }, { name: isZh ? "帕鲁图鉴" : "Pals", path: `${base}/pals` }]}>
    ...
    <PaldexClient initialPage={initialPage} initialQuery={initialQuery} locale={locale} />
    {isMainPage ? <section className="database-seo-copy paldex-seo-copy"><div>
      ...
      <h2>Reading the Pal Database</h2>
      ...
      <h2>Understanding Pal Stats and Breeding Data</h2>
      ...
      <h2>Choosing Work Suitability for a Base</h2>
      ...
      <h2>Partner Skills in Context</h2>
      ...
      <h2>Drops and Recorded Locations</h2>
      ...
      <h2>Using the List with the Palworld Breeding Calculator</h2>
